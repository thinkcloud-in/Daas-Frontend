...
let DataStores = () => {
  ...
  return (
    <div className="w-full">
      ...
      <iframe
        title="datastores"
        src={`${process.env.REACT_APP_GRAFANA_URL}/d/vsphereDS/vmware-vsphere-datastore?orgId=1&from=${gc.timeStamp.startDate}&to=${gc.timeStamp.endDate}&theme=light&disableLazyLoad=true&kiosk`}
      ></iframe>
    </div>
  );
};
